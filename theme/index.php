...
<nav class="navbar navbar-default" role="navigation" id="tsugi_tool_nav_bar">  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="classic.php" ><span class="fas fa-edit" aria-hidden="true"></span> Classic Theme</a></li>
        <li class="dropdown">
...
<div class="container-fluid"><div id="flashmessages"></div>    <div id="toolTitle" class="h1">
    ...
    <p class="lead">This is the new theme and new markup (under construction).  Eventually it will support dark mode.</p>
